...
#引入本地代码库
from torch_textcnn_text_classification_imdb import TextCNN, TEXT,LABEL

"""
在之前的textcnn上创建子类，在该子类中重载正向传播处理方法，使其支持从词嵌入层之后开始计算
"""
...
"""
加载模型权重，并用Captum库函数对模型词嵌入层进行包装，使其可以单独使用
"""
##########################
#定义模型参数
